class Graph
{
    ...
    plot()
    {
        ...
        }else if(Purchase)
        {
            ...
            if(this.shortAposx2 < width && this.shortAposx >= this.LRASx - 135)
            {
                this.shortAposx += slider.value();
                this.shortAposx2 += slider.value();
                this.offset += slider.value();
            ...
            else if(this.shortAposx <= this.LRASx - 135 && slider.value() > 0)
            {
                this.shortAposx += slider.value();
                this.shortAposx2 += slider.value();
                this.offset += slider.value();
        ...
        {
            // omo selling leads to decrease in money supply, thus decrease in AD 
            if(this.shortAposx2 > this.constant && this.shortAposx <= this.LRASx - 135)
            {
                this.shortAposx -= slider.value();
                this.shortAposx2 -= slider.value();
                this.offset -= slider.value();
